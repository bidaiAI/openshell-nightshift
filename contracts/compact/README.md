...
- `contracts/compact/src/NightShiftTaskEscrow.compact` — phase-1 public lifecycle scaffold
- `contracts/compact/simulate_state_machine.py` — local state-machine simulation for contract lifecycle

## Local verification

Run:

- `python3 contracts/compact/simulate_state_machine.py`
